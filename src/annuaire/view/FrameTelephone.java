...
public class FrameTelephone extends javax.swing.JFrame {
    ...
    //action effectuée ou la gestion des évènements du bouton d'insertion
    private void buttonAjouterActionPerformed(java.awt.event.ActionEvent evt)
    {//GEN-FIRST:event_buttonAjouterActionPerformed
        cbt.insert();
        cbt.isiTable();
        cbt.reset();
    ...
    private void buttonEffacerActionPerformed(java.awt.event.ActionEvent evt)
    {//GEN-FIRST:event_buttonEffacerActionPerformed
        cbt.reset();
    }//GEN-LAST:event_buttonEffacerActionPerformed

    //action effectuée ou la gestion des évènements du bouton de MAJ
    ...
    //action effectuée ou la gestion des évènements du bouton de suppression
    private void buttonSupprimerActionPerformed(java.awt.event.ActionEvent evt)
    {
        //GEN-FIRST:event_buttonSupprimerActionPerformed
        cbt.delete();
        cbt.isiTable();
        cbt.reset();
    }//GEN-LAST:event_buttonSupprimerActionPerformed

    //la gestion des évènements clicksouris sur une table
    private void tabelDataMouseClicked(java.awt.event.MouseEvent evt) {//GENFIRST:event_tabelDataMouseClicked
        cbt.isiField(tabelData.getSelectedRow());
    }//GEN-LAST:event_tabelDataMouseClicked

    //action effectuée ou la gestion des évènements du bouton de recherche
    private void buttonRechercheNomActionPerformed(java.awt.event.ActionEvent evt)
    {//GEN-FIRST:event_buttonRechercheNomActionPerformed
        cbt.recherchenom();
    }//GEN-LAST:event_buttonRechercheNomActionPerformed

    private void txtIDActionPerformed(java.awt.event.ActionEvent evt)
    {//GENFIRST:event_txtIDActionPerformed
